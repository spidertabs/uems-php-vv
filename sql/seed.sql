-- ============================================================ sql/seed.sql
--  UEMS-PHD-VV — Seed Data (PostgreSQL Compatible)
...
--  PostgreSQL uses a CTE to avoid repeating the hash literal
-- ============================================================
WITH pw(hash) AS (
...
CROSS JOIN (
    -- ADMIN USERS
    VALUES
    ('admin@uems.ac.ug', 'System', 'Admin', 'admin', NULL::INT, NULL::INT, '0700000000'),

    -- EXAM MASTERS
    ('exammaster@uems.ac.ug', 'Peter', 'Lutalo', 'exam_master', NULL, NULL, '0705555555'),
    ('exam.assistant@uems.ac.ug', 'Ruth', 'Nakimuli', 'exam_master', NULL, NULL, '0705555556'),
    ('exam.it@uems.ac.ug', 'Daniel', 'Kyambadde', 'exam_master', NULL, NULL, '0705555557'),
    ('exam.sciences@uems.ac.ug', 'Catherine', 'Nabatanzi', 'exam_master', NULL, NULL, '0705555558'),
    ('exam.law@uems.ac.ug', 'Henry', 'Wasswa', 'exam_master', NULL, NULL, '0705555559'),

    -- DEANS (COLLEGES / SCHOOLS)
    -- 1=SOAS, 2=SPS, 3=SDDEL, 4=SEAS, 5=SOL, 6=SOMAC, 7=SONAS, 8=SPH,
    -- 9=CEM, 10=CEODL, 11=CHSS
    ('dean.soas@uems.ac.ug', 'John', 'Katumba', 'dean', NULL, 1, '0701111111'),
    ('dean.sps@uems.ac.ug', 'Sarah', 'Nanyonga', 'dean', NULL, 2, '0702222222'),
    ('dean.sph@uems.ac.ug', 'Michael', 'Okello', 'dean', NULL, 8, '0703333333'),
    ('dean.sol@uems.ac.ug', 'Elizabeth', 'Namubiru', 'dean', NULL, 5, '0703333334'),
    ('dean.cem@uems.ac.ug', 'Alice', 'Kakuru', 'dean', NULL, 9, '0704444444'),
    ('dean.ceodl@uems.ac.ug', 'Simon', 'Mwebaze', 'dean', NULL, 10, '0704444445'),
    ('dean.seas@uems.ac.ug', 'Christopher', 'Tugume', 'dean', NULL, 4, '0704444446'),
    ('dean.chss@uems.ac.ug', 'Margaret', 'Kwagala', 'dean', NULL, 11, '0704444447'),
    ('dean.research@uems.ac.ug', 'Paul', 'Mukasa', 'dean', NULL, NULL, '0704444448'),
    ('dean.students@uems.ac.ug', 'Jane', 'Nakibuka', 'dean', NULL, NULL, '0704444449'),

    -- ============================================================
    -- HEADS OF DEPARTMENT (HODs)
    -- dept 1=AGRIC … 43=POL  →  user ids 17–59
    -- ============================================================

    -- Agriculture (College 1) — depts 1-3
    ('hod.agric@uems.ac.ug', 'Joseph', 'Mugerwa', 'hod', 1, 1, '0706000001'),
    ('hod.agbus@uems.ac.ug', 'Sarah', 'Nabirye', 'hod', 2, 1, '0706000002'),
    ('hod.envs@uems.ac.ug', 'Francis', 'Opolot', 'hod', 3, 1, '0706000003'),

    -- Professional Studies (College 2) — dept 4
    ('hod.prof@uems.ac.ug', 'Brenda', 'Kansiime', 'hod', 4, 2, '0706000004'),

    -- Distance Learning (College 3) — dept 5
    ('hod.ddel@uems.ac.ug', 'Ronald', 'Kato', 'hod', 5, 3, '0706000005'),

    -- Engineering (College 4) — depts 6-9
    ('hod.civ@uems.ac.ug', 'Francis', 'Okello', 'hod', 6, 4, '0706000006'),
    ('hod.ele@uems.ac.ug', 'James', 'Kato', 'hod', 7, 4, '0706000007'),
    ('hod.mec@uems.ac.ug', 'Sarah', 'Tendo', 'hod', 8, 4, '0706000008'),
    ('hod.tel@uems.ac.ug', 'Robert', 'Mugambwa', 'hod', 9, 4, '0706000009'),

    -- Law (College 5) — depts 10-13
    ('hod.law@uems.ac.ug', 'Julius', 'Businge', 'hod', 10, 5, '0706000010'),
    ('hod.cml@uems.ac.ug', 'Monica', 'Kyomugisha', 'hod', 11, 5, '0706000011'),
    ('hod.iel@uems.ac.ug', 'Patrick', 'Mugisha', 'hod', 12, 5, '0706000012'),
    ('hod.ipl@uems.ac.ug', 'Susan', 'Namutebi', 'hod', 13, 5, '0706000013'),

    -- Computing & Mathematics (College 6) — depts 14-17
    ('hod.cs@uems.ac.ug', 'Derrick', 'Mugisha', 'hod', 14, 6, '0706000014'),
    ('hod.it@uems.ac.ug', 'Moses', 'Nabende', 'hod', 15, 6, '0706000015'),
    ('hod.se@uems.ac.ug', 'Daniel', 'Okumu', 'hod', 16, 6, '0706000016'),
    ('hod.math@uems.ac.ug', 'Caroline', 'Nabirye', 'hod', 17, 6, '0706000017'),

    -- Natural Sciences (College 7) — depts 18-21
    ('hod.env@uems.ac.ug', 'Catherine', 'Nalwoga', 'hod', 18, 7, '0706000018'),
    ('hod.phy@uems.ac.ug', 'Rogers', 'Wamala', 'hod', 19, 7, '0706000019'),
    ('hod.chem@uems.ac.ug', 'Isaac', 'Baluku', 'hod', 20, 7, '0706000020'),
    ('hod.bio@uems.ac.ug', 'Lydia', 'Namara', 'hod', 21, 7, '0706000021'),

    -- Public Health (College 8) — depts 22-24
    ('hod.ph@uems.ac.ug', 'David', 'Tumusiime', 'hod', 22, 8, '0706000022'),
    ('hod.epid@uems.ac.ug', 'Grace', 'Nakato', 'hod', 23, 8, '0706000023'),
    ('hod.hsm@uems.ac.ug', 'Andrew', 'Kisembo', 'hod', 24, 8, '0706000024'),

    -- Business (College 9) — depts 25-31
    ('hod.acc@uems.ac.ug', 'Thomas', 'Wasswa', 'hod', 25, 9, '0706000025'),
    ('hod.bus@uems.ac.ug', 'Joyce', 'Nalubega', 'hod', 26, 9, '0706000026'),
    ('hod.hrm@uems.ac.ug', 'Richard', 'Kigozi', 'hod', 27, 9, '0706000027'),
    ('hod.mkt@uems.ac.ug', 'Esther', 'Nabatanzi', 'hod', 28, 9, '0706000028'),
    ('hod.ent@uems.ac.ug', 'Peter', 'Muwanga', 'hod', 29, 9, '0706000029'),
    ('hod.eco@uems.ac.ug', 'Samuel', 'Kyeyune', 'hod', 30, 9, '0706000030'),
    ('hod.scm@uems.ac.ug', 'Rebecca', 'Nakafeero', 'hod', 31, 9, '0706000031'),

    -- Education (College 10) — depts 32-35
    ('hod.edu@uems.ac.ug', 'Matthew', 'Kigozi', 'hod', 32, 10, '0706000032'),
    ('hod.eng@uems.ac.ug', 'Dorothy', 'Nansubuga', 'hod', 33, 10, '0706000033'),
    ('hod.ling@uems.ac.ug', 'Stephen', 'Ssematimba', 'hod', 34, 10, '0706000034'),
    ('hod.edadmin@uems.ac.ug', 'Janet', 'Namukasa', 'hod', 35, 10, '0706000035'),

    -- Social Sciences (College 11) — depts 36-43
    ('hod.sws@uems.ac.ug', 'Peter', 'Namugera', 'hod', 36, 11, '0706000036'),
    ('hod.gic@uems.ac.ug', 'Rose', 'Nalule', 'hod', 37, 11, '0706000037'),
    ('hod.psy@uems.ac.ug', 'Martin', 'Ssali', 'hod', 38, 11, '0706000038'),
    ('hod.dvs@uems.ac.ug', 'Mary', 'Kemigisha', 'hod', 39, 11, '0706000039'),
    ('hod.crp@uems.ac.ug', 'Alex', 'Mugisha', 'hod', 40, 11, '0706000040'),
    ('hod.mco@uems.ac.ug', 'Patricia', 'Nabukenya', 'hod', 41, 11, '0706000041'),
    ('hod.pad@uems.ac.ug', 'George', 'Kisitu', 'hod', 42, 11, '0706000042'),
    ('hod.pol@uems.ac.ug', 'Lydia', 'Nansikombi', 'hod', 43, 11, '0706000043'),

    -- ============================================================
    -- LECTURERS — user ids start at 60
    -- ============================================================

    -- Agriculture (dept 1)
    ('lect.agric1@uems.ac.ug', 'Joseph', 'Wandera', 'lecturer', 1, 1, '0707000001'),
    ('lect.agric2@uems.ac.ug', 'Esther', 'Namuli', 'lecturer', 1, 1, '0707000002'),
    ('lect.agric3@uems.ac.ug', 'Robert', 'Ocen', 'lecturer', 1, 1, '0707000003'),
    ('lect.agric4@uems.ac.ug', 'Grace', 'Auma', 'lecturer', 1, 1, '0707000004'),

    -- Agribusiness (dept 2)
    ('lect.agbus1@uems.ac.ug', 'Peter', 'Wasswa', 'lecturer', 2, 1, '0707000005'),
    ('lect.agbus2@uems.ac.ug', 'Sarah', 'Nakato', 'lecturer', 2, 1, '0707000006'),
    ('lect.agbus3@uems.ac.ug', 'David', 'Okello', 'lecturer', 2, 1, '0707000007'),

    -- Environmental Studies (dept 3)
    ('lect.envs1@uems.ac.ug', 'Catherine', 'Nalwoga', 'lecturer', 3, 1, '0707000008'),
    ('lect.envs2@uems.ac.ug', 'James', 'Otim', 'lecturer', 3, 1, '0707000009'),
    ('lect.envs3@uems.ac.ug', 'Ruth', 'Nabukenya', 'lecturer', 3, 1, '0707000010'),

    -- Professional Studies (dept 4)
    ('lect.prof1@uems.ac.ug', 'Sarah', 'Nabirye', 'lecturer', 4, 2, '0707000011'),
    ('lect.prof2@uems.ac.ug', 'David', 'Mugisha', 'lecturer', 4, 2, '0707000012'),
    ('lect.prof3@uems.ac.ug', 'Grace', 'Namukasa', 'lecturer', 4, 2, '0707000013'),

    -- Distance Learning (dept 5)
    ('lect.ddel1@uems.ac.ug', 'Ronald', 'Kato', 'lecturer', 5, 3, '0707000014'),
    ('lect.ddel2@uems.ac.ug', 'Mary', 'Nalwoga', 'lecturer', 5, 3, '0707000015'),
    ('lect.ddel3@uems.ac.ug', 'Peter', 'Mugisha', 'lecturer', 5, 3, '0707000016'),

    -- Civil Engineering (dept 6)
    ('lect.civ1@uems.ac.ug', 'Francis', 'Okello', 'lecturer', 6, 4, '0707000017'),
    ('lect.civ2@uems.ac.ug', 'Sarah', 'Nabukenya', 'lecturer', 6, 4, '0707000018'),
    ('lect.civ3@uems.ac.ug', 'David', 'Wasswa', 'lecturer', 6, 4, '0707000019'),
    ('lect.civ4@uems.ac.ug', 'Grace', 'Namuli', 'lecturer', 6, 4, '0707000020'),
    ('lect.civ5@uems.ac.ug', 'Robert', 'Mugisha', 'lecturer', 6, 4, '0707000021'),

    -- Electrical Engineering (dept 7)
    ('lect.ele1@uems.ac.ug', 'James', 'Kato', 'lecturer', 7, 4, '0707000022'),
    ('lect.ele2@uems.ac.ug', 'Sarah', 'Nabatanzi', 'lecturer', 7, 4, '0707000023'),
    ('lect.ele3@uems.ac.ug', 'David', 'Mugisha', 'lecturer', 7, 4, '0707000024'),
    ('lect.ele4@uems.ac.ug', 'Grace', 'Nalwoga', 'lecturer', 7, 4, '0707000025'),
    ('lect.ele5@uems.ac.ug', 'Robert', 'Wasswa', 'lecturer', 7, 4, '0707000026'),

    -- Mechanical Engineering (dept 8)
    ('lect.mec1@uems.ac.ug', 'Sarah', 'Tendo', 'lecturer', 8, 4, '0707000027'),
    ('lect.mec2@uems.ac.ug', 'David', 'Kato', 'lecturer', 8, 4, '0707000028'),
    ('lect.mec3@uems.ac.ug', 'Grace', 'Nabukenya', 'lecturer', 8, 4, '0707000029'),
    ('lect.mec4@uems.ac.ug', 'Robert', 'Mugisha', 'lecturer', 8, 4, '0707000030'),

    -- Telecommunications Engineering (dept 9)
    ('lect.tel1@uems.ac.ug', 'Robert', 'Mugambwa', 'lecturer', 9, 4, '0707000031'),
    ('lect.tel2@uems.ac.ug', 'Sarah', 'Nalwoga', 'lecturer', 9, 4, '0707000032'),
    ('lect.tel3@uems.ac.ug', 'David', 'Wasswa', 'lecturer', 9, 4, '0707000033'),
    ('lect.tel4@uems.ac.ug', 'Grace', 'Namukasa', 'lecturer', 9, 4, '0707000034'),

    -- Law (dept 10)
    ('lect.law1@uems.ac.ug', 'Robert', 'Turyasingura', 'lecturer', 10, 5, '0707000035'),
    ('lect.law2@uems.ac.ug', 'Grace', 'Nabukeera', 'lecturer', 10, 5, '0707000036'),
    ('lect.law3@uems.ac.ug', 'James', 'Mugisha', 'lecturer', 10, 5, '0707000037'),
    ('lect.law4@uems.ac.ug', 'Sarah', 'Namukasa', 'lecturer', 10, 5, '0707000038'),
    ('lect.law5@uems.ac.ug', 'David', 'Kato', 'lecturer', 10, 5, '0707000039'),

    -- Commercial Law (dept 11)
    ('lect.cml1@uems.ac.ug', 'Monica', 'Kyomugisha', 'lecturer', 11, 5, '0707000040'),
    ('lect.cml2@uems.ac.ug', 'Peter', 'Wasswa', 'lecturer', 11, 5, '0707000041'),
    ('lect.cml3@uems.ac.ug', 'Ruth', 'Nabatanzi', 'lecturer', 11, 5, '0707000042'),

    -- International and Economic Law (dept 12)
    ('lect.iel1@uems.ac.ug', 'Patrick', 'Mugisha', 'lecturer', 12, 5, '0707000043'),
    ('lect.iel2@uems.ac.ug', 'Sarah', 'Nabukeera', 'lecturer', 12, 5, '0707000044'),
    ('lect.iel3@uems.ac.ug', 'David', 'Kisitu', 'lecturer', 12, 5, '0707000045'),

    -- Intellectual Property Law (dept 13)
    ('lect.ipl1@uems.ac.ug', 'Susan', 'Namutebi', 'lecturer', 13, 5, '0707000046'),
    ('lect.ipl2@uems.ac.ug', 'Robert', 'Mugerwa', 'lecturer', 13, 5, '0707000047'),
    ('lect.ipl3@uems.ac.ug', 'Grace', 'Nalwoga', 'lecturer', 13, 5, '0707000048'),

    -- Computer Science (dept 14)
    ('lect.cs1@uems.ac.ug', 'Paul', 'Mutebi', 'lecturer', 14, 6, '0707000049'),
    ('lect.cs2@uems.ac.ug', 'Sarah', 'Nakibuuka', 'lecturer', 14, 6, '0707000050'),
    ('lect.cs3@uems.ac.ug', 'Robert', 'Kakembo', 'lecturer', 14, 6, '0707000051'),
    ('lect.cs4@uems.ac.ug', 'Grace', 'Nabukeera', 'lecturer', 14, 6, '0707000052'),
    ('lect.cs5@uems.ac.ug', 'David', 'Ssempijja', 'lecturer', 14, 6, '0707000053'),

    -- Information Technology (dept 15)
    ('lect.it1@uems.ac.ug', 'Moses', 'Nabende', 'lecturer', 15, 6, '0707000054'),
    ('lect.it2@uems.ac.ug', 'Esther', 'Namuli', 'lecturer', 15, 6, '0707000055'),
    ('lect.it3@uems.ac.ug', 'Henry', 'Kato', 'lecturer', 15, 6, '0707000056'),
    ('lect.it4@uems.ac.ug', 'Joyce', 'Nalwadda', 'lecturer', 15, 6, '0707000057'),
    ('lect.it5@uems.ac.ug', 'Richard', 'Mugisha', 'lecturer', 15, 6, '0707000058'),

    -- Software Engineering (dept 16)
    ('lect.se1@uems.ac.ug', 'Daniel', 'Okumu', 'lecturer', 16, 6, '0707000059'),
    ('lect.se2@uems.ac.ug', 'Catherine', 'Nabatanzi', 'lecturer', 16, 6, '0707000060'),
    ('lect.se3@uems.ac.ug', 'Peter', 'Lwanga', 'lecturer', 16, 6, '0707000061'),
    ('lect.se4@uems.ac.ug', 'Sarah', 'Nabukeera', 'lecturer', 16, 6, '0707000062'),
    ('lect.se5@uems.ac.ug', 'Thomas', 'Ssali', 'lecturer', 16, 6, '0707000063'),

    -- Mathematics (dept 17)
    ('lect.math1@uems.ac.ug', 'Robert', 'Wandera', 'lecturer', 17, 6, '0707000064'),
    ('lect.math2@uems.ac.ug', 'Alice', 'Nakintu', 'lecturer', 17, 6, '0707000065'),
    ('lect.math3@uems.ac.ug', 'John', 'Kisakye', 'lecturer', 17, 6, '0707000066'),
    ('lect.math4@uems.ac.ug', 'Grace', 'Namugga', 'lecturer', 17, 6, '0707000067'),
    ('lect.math5@uems.ac.ug', 'David', 'Mugerwa', 'lecturer', 17, 6, '0707000068'),

    -- Environmental Management (dept 18)
    ('lect.env1@uems.ac.ug', 'Catherine', 'Nalwoga', 'lecturer', 18, 7, '0707000069'),
    ('lect.env2@uems.ac.ug', 'James', 'Otim', 'lecturer', 18, 7, '0707000070'),
    ('lect.env3@uems.ac.ug', 'Ruth', 'Nabukenya', 'lecturer', 18, 7, '0707000071'),
    ('lect.env4@uems.ac.ug', 'Paul', 'Okello', 'lecturer', 18, 7, '0707000072'),

    -- Physics (dept 19)
    ('lect.phy1@uems.ac.ug', 'Samuel', 'Okello', 'lecturer', 19, 7, '0707000073'),
    ('lect.phy2@uems.ac.ug', 'Mary', 'Achan', 'lecturer', 19, 7, '0707000074'),
    ('lect.phy3@uems.ac.ug', 'Joseph', 'Ocaya', 'lecturer', 19, 7, '0707000075'),
    ('lect.phy4@uems.ac.ug', 'Grace', 'Atim', 'lecturer', 19, 7, '0707000076'),

    -- Chemistry (dept 20)
    ('lect.chem1@uems.ac.ug', 'Isaac', 'Okurut', 'lecturer', 20, 7, '0707000077'),
    ('lect.chem2@uems.ac.ug', 'Susan', 'Kemigisha', 'lecturer', 20, 7, '0707000078'),
    ('lect.chem3@uems.ac.ug', 'Patrick', 'Odongo', 'lecturer', 20, 7, '0707000079'),
    ('lect.chem4@uems.ac.ug', 'Rebecca', 'Nanyonjo', 'lecturer', 20, 7, '0707000080'),

    -- Biology (dept 21)
    ('lect.bio1@uems.ac.ug', 'Lydia', 'Nabukenya', 'lecturer', 21, 7, '0707000081'),
    ('lect.bio2@uems.ac.ug', 'Charles', 'Mugisha', 'lecturer', 21, 7, '0707000082'),
    ('lect.bio3@uems.ac.ug', 'Sarah', 'Namayanja', 'lecturer', 21, 7, '0707000083'),
    ('lect.bio4@uems.ac.ug', 'Peter', 'Okot', 'lecturer', 21, 7, '0707000084'),

    -- Public Health (dept 22)
    ('lect.ph1@uems.ac.ug', 'David', 'Kato', 'lecturer', 22, 8, '0707000085'),
    ('lect.ph2@uems.ac.ug', 'Sarah', 'Nabirye', 'lecturer', 22, 8, '0707000086'),
    ('lect.ph3@uems.ac.ug', 'James', 'Okello', 'lecturer', 22, 8, '0707000087'),
    ('lect.ph4@uems.ac.ug', 'Mary', 'Nakafeero', 'lecturer', 22, 8, '0707000088'),

    -- Epidemiology (dept 23)
    ('lect.epid1@uems.ac.ug', 'Grace', 'Nabukenya', 'lecturer', 23, 8, '0707000089'),
    ('lect.epid2@uems.ac.ug', 'Robert', 'Mugisha', 'lecturer', 23, 8, '0707000090'),
    ('lect.epid3@uems.ac.ug', 'John', 'Otim', 'lecturer', 23, 8, '0707000091'),

    -- Health Systems Management (dept 24)
    ('lect.hsm1@uems.ac.ug', 'Sarah', 'Nabatanzi', 'lecturer', 24, 8, '0707000092'),
    ('lect.hsm2@uems.ac.ug', 'David', 'Kisitu', 'lecturer', 24, 8, '0707000093'),
    ('lect.hsm3@uems.ac.ug', 'Esther', 'Nalwoga', 'lecturer', 24, 8, '0707000094'),

    -- Accounting (dept 25)
    ('lect.acc1@uems.ac.ug', 'Geoffrey', 'Nsubuga', 'lecturer', 25, 9, '0707000095'),
    ('lect.acc2@uems.ac.ug', 'Sarah', 'Nabukenya', 'lecturer', 25, 9, '0707000096'),
    ('lect.acc3@uems.ac.ug', 'David', 'Wasswa', 'lecturer', 25, 9, '0707000097'),
    ('lect.acc4@uems.ac.ug', 'Grace', 'Namuli', 'lecturer', 25, 9, '0707000098'),
    ('lect.acc5@uems.ac.ug', 'Robert', 'Kigozi', 'lecturer', 25, 9, '0707000099'),

    -- Business Administration (dept 26)
    ('lect.bus1@uems.ac.ug', 'Joyce', 'Nalubega', 'lecturer', 26, 9, '0707000100'),
    ('lect.bus2@uems.ac.ug', 'Peter', 'Mugisha', 'lecturer', 26, 9, '0707000101'),
    ('lect.bus3@uems.ac.ug', 'Sarah', 'Nabatanzi', 'lecturer', 26, 9, '0707000102'),
    ('lect.bus4@uems.ac.ug', 'David', 'Kato', 'lecturer', 26, 9, '0707000103'),
    ('lect.bus5@uems.ac.ug', 'Grace', 'Nalwadda', 'lecturer', 26, 9, '0707000104'),

    -- Human Resource Management (dept 27)
    ('lect.hrm1@uems.ac.ug', 'Richard', 'Kigozi', 'lecturer', 27, 9, '0707000105'),
    ('lect.hrm2@uems.ac.ug', 'Sarah', 'Nabukeera', 'lecturer', 27, 9, '0707000106'),
    ('lect.hrm3@uems.ac.ug', 'David', 'Mugisha', 'lecturer', 27, 9, '0707000107'),
    ('lect.hrm4@uems.ac.ug', 'Grace', 'Namukasa', 'lecturer', 27, 9, '0707000108'),

    -- Marketing (dept 28)
    ('lect.mkt1@uems.ac.ug', 'Esther', 'Nabatanzi', 'lecturer', 28, 9, '0707000109'),
    ('lect.mkt2@uems.ac.ug', 'Peter', 'Wasswa', 'lecturer', 28, 9, '0707000110'),
    ('lect.mkt3@uems.ac.ug', 'Sarah', 'Nalwoga', 'lecturer', 28, 9, '0707000111'),
    ('lect.mkt4@uems.ac.ug', 'David', 'Kisitu', 'lecturer', 28, 9, '0707000112'),

    -- Entrepreneurship (dept 29)
    ('lect.ent1@uems.ac.ug', 'Peter', 'Muwanga', 'lecturer', 29, 9, '0707000113'),
    ('lect.ent2@uems.ac.ug', 'Grace', 'Nabukenya', 'lecturer', 29, 9, '0707000114'),
    ('lect.ent3@uems.ac.ug', 'Robert', 'Mugisha', 'lecturer', 29, 9, '0707000115'),

    -- Economics (dept 30)
    ('lect.eco1@uems.ac.ug', 'Samuel', 'Kyeyune', 'lecturer', 30, 9, '0707000116'),
    ('lect.eco2@uems.ac.ug', 'Sarah', 'Namuli', 'lecturer', 30, 9, '0707000117'),
    ('lect.eco3@uems.ac.ug', 'David', 'Okello', 'lecturer', 30, 9, '0707000118'),
    ('lect.eco4@uems.ac.ug', 'Grace', 'Nabatanzi', 'lecturer', 30, 9, '0707000119'),

    -- Supply Chain Management (dept 31)
    ('lect.scm1@uems.ac.ug', 'Rebecca', 'Nakafeero', 'lecturer', 31, 9, '0707000120'),
    ('lect.scm2@uems.ac.ug', 'Peter', 'Mugisha', 'lecturer', 31, 9, '0707000121'),
    ('lect.scm3@uems.ac.ug', 'Sarah', 'Nabukenya', 'lecturer', 31, 9, '0707000122'),

    -- Education (dept 32)
    ('lect.edu1@uems.ac.ug', 'Matthew', 'Kigozi', 'lecturer', 32, 10, '0707000123'),
    ('lect.edu2@uems.ac.ug', 'Sarah', 'Nalwoga', 'lecturer', 32, 10, '0707000124'),
    ('lect.edu3@uems.ac.ug', 'David', 'Wasswa', 'lecturer', 32, 10, '0707000125'),
    ('lect.edu4@uems.ac.ug', 'Grace', 'Namukasa', 'lecturer', 32, 10, '0707000126'),
    ('lect.edu5@uems.ac.ug', 'Robert', 'Mugisha', 'lecturer', 32, 10, '0707000127'),

    -- English (dept 33)
    ('lect.eng1@uems.ac.ug', 'Dorothy', 'Nansubuga', 'lecturer', 33, 10, '0707000128'),
    ('lect.eng2@uems.ac.ug', 'Peter', 'Mugisha', 'lecturer', 33, 10, '0707000129'),
    ('lect.eng3@uems.ac.ug', 'Sarah', 'Nabatanzi', 'lecturer', 33, 10, '0707000130'),
    ('lect.eng4@uems.ac.ug', 'David', 'Kisitu', 'lecturer', 33, 10, '0707000131'),

    -- Linguistics (dept 34)
    ('lect.ling1@uems.ac.ug', 'Stephen', 'Ssematimba', 'lecturer', 34, 10, '0707000132'),
    ('lect.ling2@uems.ac.ug', 'Grace', 'Nabukenya', 'lecturer', 34, 10, '0707000133'),
    ('lect.ling3@uems.ac.ug', 'Robert', 'Mugisha', 'lecturer', 34, 10, '0707000134'),

    -- Educational Administration (dept 35)
    ('lect.edadmin1@uems.ac.ug', 'Janet', 'Namukasa', 'lecturer', 35, 10, '0707000135'),
    ('lect.edadmin2@uems.ac.ug', 'Peter', 'Wasswa', 'lecturer', 35, 10, '0707000136'),
    ('lect.edadmin3@uems.ac.ug', 'Sarah', 'Nalwoga', 'lecturer', 35, 10, '0707000137'),

    -- Social Work (dept 36)
    ('lect.sws1@uems.ac.ug', 'Peter', 'Namugera', 'lecturer', 36, 11, '0707000138'),
    ('lect.sws2@uems.ac.ug', 'Sarah', 'Nabukenya', 'lecturer', 36, 11, '0707000139'),
    ('lect.sws3@uems.ac.ug', 'David', 'Wasswa', 'lecturer', 36, 11, '0707000140'),
    ('lect.sws4@uems.ac.ug', 'Grace', 'Namuli', 'lecturer', 36, 11, '0707000141'),

    -- Guidance and Counselling (dept 37)
    ('lect.gic1@uems.ac.ug', 'Rose', 'Nalule', 'lecturer', 37, 11, '0707000142'),
    ('lect.gic2@uems.ac.ug', 'Peter', 'Mugisha', 'lecturer', 37, 11, '0707000143'),
    ('lect.gic3@uems.ac.ug', 'Sarah', 'Nabatanzi', 'lecturer', 37, 11, '0707000144'),
    ('lect.gic4@uems.ac.ug', 'David', 'Kisitu', 'lecturer', 37, 11, '0707000145'),

    -- Psychology (dept 38)
    ('lect.psy1@uems.ac.ug', 'Martin', 'Ssali', 'lecturer', 38, 11, '0707000146'),
    ('lect.psy2@uems.ac.ug', 'Sarah', 'Nalwoga', 'lecturer', 38, 11, '0707000147'),
    ('lect.psy3@uems.ac.ug', 'David', 'Mugisha', 'lecturer', 38, 11, '0707000148'),
    ('lect.psy4@uems.ac.ug', 'Grace', 'Nabukenya', 'lecturer', 38, 11, '0707000149'),

    -- Development Studies (dept 39)
    ('lect.dvs1@uems.ac.ug', 'Mary', 'Kemigisha', 'lecturer', 39, 11, '0707000150'),
    ('lect.dvs2@uems.ac.ug', 'Peter', 'Wasswa', 'lecturer', 39, 11, '0707000151'),
    ('lect.dvs3@uems.ac.ug', 'Sarah', 'Nalwoga', 'lecturer', 39, 11, '0707000152'),

    -- Conflict Resolution and Peace (dept 40)
    ('lect.crp1@uems.ac.ug', 'Alex', 'Mugisha', 'lecturer', 40, 11, '0707000153'),
    ('lect.crp2@uems.ac.ug', 'Grace', 'Nabukenya', 'lecturer', 40, 11, '0707000154'),
    ('lect.crp3@uems.ac.ug', 'David', 'Kato', 'lecturer', 40, 11, '0707000155'),

    -- Mass Communication (dept 41)
    ('lect.mco1@uems.ac.ug', 'Patricia', 'Nabukenya', 'lecturer', 41, 11, '0707000156'),
    ('lect.mco2@uems.ac.ug', 'Peter', 'Mugisha', 'lecturer', 41, 11, '0707000157'),
    ('lect.mco3@uems.ac.ug', 'Sarah', 'Nalwoga', 'lecturer', 41, 11, '0707000158'),
    ('lect.mco4@uems.ac.ug', 'David', 'Wasswa', 'lecturer', 41, 11, '0707000159'),

    -- Public Administration (dept 42)
    ('lect.pad1@uems.ac.ug', 'George', 'Kisitu', 'lecturer', 42, 11, '0707000160'),
    ('lect.pad2@uems.ac.ug', 'Sarah', 'Nabukenya', 'lecturer', 42, 11, '0707000161'),
    ('lect.pad3@uems.ac.ug', 'David', 'Mugisha', 'lecturer', 42, 11, '0707000162'),
    ('lect.pad4@uems.ac.ug', 'Grace', 'Namuli', 'lecturer', 42, 11, '0707000163'),

    -- Political Science (dept 43)
    ('lect.pol1@uems.ac.ug', 'Lydia', 'Nansikombi', 'lecturer', 43, 11, '0707000164'),
    ('lect.pol2@uems.ac.ug', 'Peter', 'Wasswa', 'lecturer', 43, 11, '0707000165'),
    ('lect.pol3@uems.ac.ug', 'David', 'Kato', 'lecturer', 43, 11, '0707000166'),
    ('lect.pol4@uems.ac.ug', 'Sarah', 'Nalwoga', 'lecturer', 43, 11, '0707000167')
...
-- ============================================================
--  Courses
--  HOD user-id reference map (dept → user id):
...
-- Bachelor of Science in Civil Engineering — Year 2
...
-- ============================================================================
-- CEODL (CENTER FOR EXTERNAL AND OPEN DISTANCE LEARNING)
-- ============================================================================
