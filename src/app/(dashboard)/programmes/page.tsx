    ...
    <div className="space-y-6 lg:pl-64">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-4">
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400">Total Programmes</div>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
          <div className="text-2xl font-bold text-green-600">
            {programmes.filter((p) => p.is_active).length}
          </div>
          <div className="text-sm text-gray-600 dark:text-gray-400">Active Programmes</div>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-800">
          <div className="text-2xl font-bold text-orange-600">{filteredProgrammes.length}</div>
          ...
          <table className="w-full">
            <thead className="border-b border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-900">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-900 dark:text-white">Programme Name</th>
              ...
              {filteredProgrammes.length > 0 ? (
                filteredProgrammes.map((programme) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <div className="text-xs text-gray-500">{programme.college_name}</div>
                    </td>
                    <td className="px-6 py-4">
                      <button
                        onClick={() => toggleStatus(programme.id, programme.is_active)}
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-12 text-center">
                    ...
                    <p className="mt-4 text-gray-600 dark:text-gray-400">No programmes found</p>
                  </td>
                </tr>
              )}
            </tbody>
