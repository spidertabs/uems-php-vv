  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 lg:pl-64">
      ...
      <div className="no-print sticky top-0 z-10 bg-white p-4 shadow-md dark:bg-gray-800">
        <div className="mb-2 rounded bg-yellow-50 px-3 py-1 text-xs text-yellow-800 border border-yellow-200">
          💡 <strong>Print tip:</strong> In the print dialog, set <strong>Margins to None</strong> and uncheck <strong>Headers and footers</strong> to avoid blank pages.
        </div>
      ...
      >
        ...
        {/* Footer */}
        <div className="mt-6 border-t-2 border-gray-900 pt-4 text-center text-xs text-gray-700 dark:border-gray-300 dark:text-gray-400 print:border-black print:text-black">
      ...
      <style jsx global>{`
        @media print {
          ...
          /* Remove min-height and excess padding that causes blank pages */
          [style*="minHeight"],
          [style*="min-height"] {
            min-height: 0 !important;
          }

          /* Kill the outer wrapper padding/margin */
          .min-h-screen {
            min-height: 0 !important;
            padding: 0 !important;
            margin: 0 !important;
